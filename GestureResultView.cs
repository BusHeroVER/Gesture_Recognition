...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    {
        private readonly ImageSource standImage = new BitmapImage(new Uri(@"Images\stand.png", UriKind.Relative));
        private readonly ImageSource sittingImage = new BitmapImage(new Uri(@"Images\sitting.png", UriKind.Relative));
        private readonly ImageSource standRockImage = new BitmapImage(new Uri(@"Images\standrock.png", UriKind.Relative));
        private readonly ImageSource sittingRockImage = new BitmapImage(new Uri(@"Images\sittingrock.png", UriKind.Relative));
        private readonly ImageSource standHeadImage = new BitmapImage(new Uri(@"Images\standhead.png", UriKind.Relative));
        private readonly ImageSource sittingHeadImage = new BitmapImage(new Uri(@"Images\sittinghead.png", UriKind.Relative));

        /// <summary> Image to show when the 'detected' property is true for a tracked body </summary>
        //private readonly ImageSource rockImage = new BitmapImage(new Uri(@"Images\rock.png", UriKind.Relative));
        //private readonly ImageSource danceImage = new BitmapImage(new Uri(@"Images\dance.png", UriKind.Relative));

        /// <summary> Image to show when the 'detected' property is false for a tracked body </summary>
        //private readonly ImageSource notrockImage = new BitmapImage(new Uri(@"Images\Notrock.png", UriKind.Relative));
        //private readonly ImageSource notdanceImage = new BitmapImage(new Uri(@"Images\Notdance.png", UriKind.Relative));
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, double detectionConfidence, int gestureBit)
        {
            ...
            else
            {
                ...
                this.Confidence = Convert.ToSingle(detectionConfidence);
                ...
                if (this.Detected)
                {
                    ...
                    {
                        case 0://stand
                            this.ImageSource = this.standImage;
                            break;
                        case 1://sitting
                            this.ImageSource = this.sittingImage;
                            break;
                        case 2://stand & rock
                            this.ImageSource = this.standRockImage;
                            break;
                        case 3://sitting & rock
                            this.ImageSource = this.sittingRockImage;
                            break;
                        case 4://stand & head
                            this.ImageSource = this.standHeadImage;
                            break;
                        case 5://sitting & head
                            this.ImageSource = this.sittingHeadImage;
                            break;
                        default :
                            break;
                    }
